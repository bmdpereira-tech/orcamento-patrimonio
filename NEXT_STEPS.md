...
- A última alteração funcional é a aceitação de expressões matemáticas simples em `Movimentos realizados`, com cálculo apenas no commit da edição.
...
- Confirmar que, durante a escrita, o campo mantém exactamente o texto bruto e não recalcula a tabela.
- Confirmar que Enter, Tab/mudança de célula e blur guardam apenas o resultado final.
